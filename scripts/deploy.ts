...
let main = async () => {
  ...
  //const instance = (await ConfigAddressFactory.connect(owner).attach("0xdcC2b88c5A1d48FeF34091070789B5aaCA8F4C70"))as ConfigAddress;//0x83f238F8a8F557dEdE7aE201434f5FB3bC2dE1F9
  ...
  let cmdStr =
    'sed -i -e   \'s/address.*#0x3BCC716d7F478E4eec25647f0A9098E734FF1d32/address: "' +
    instance.address +
    '" #0x3BCC716d7F478E4eec25647f0A9098E734FF1d32/g\'  subgraph.yaml';
  ...
  if (blockNumber) {
    cmdStr =
      "sed -i -e   's/startBlock.*#0x3BCC716d7F478E4eec25647f0A9098E734FF1d32/startBlock: " +
      blockNumber +
      " #0x3BCC716d7F478E4eec25647f0A9098E734FF1d32/g'  subgraph.yaml";
    exec(cmdStr, function (err, stdout, stderr) {});
  }
